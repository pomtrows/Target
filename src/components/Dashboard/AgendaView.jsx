    ...
    <div className="agenda-container glass rounded-3xl border border-dark-600/25 flex flex-col h-[650px] overflow-hidden bg-dark-900/30">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div 
          ref={containerRef}
          onScroll={(e) => {
            // Sync the vertical scroll position to the Hours Scale
            const hoursEl = document.getElementById('hours-scroll-sync');
            if (hoursEl) {
              hoursEl.scrollTop = e.currentTarget.scrollTop;
            }
          }}
